...
const CategoryManage = () => {
  ...
  const templateCategories = [
    { name: 'Fruits & Vegetables', icon: '🍎', image: '/src/assets/Fruits & Vegetables.jpg' },
    { name: 'Dairy & Breakfast', icon: '🥛', image: '/src/assets/Dairy & Breakfast.jpg' },
    { name: 'Munchies', icon: '🍪', image: '/src/assets/Munchies.jpg' },
    { name: 'Cold Drinks', icon: '🥤', image: '/src/assets/Cold Drinks.jpg' },
    { name: 'Sweet Cravings', icon: '🍫', image: '/src/assets/Sweet Cravings.jpg' },
    { name: 'Chicken & Eggs', icon: '🥚', image: '/src/assets/Chicken & Eggs.jpg' },
    { name: 'Cleaning', icon: '🧹', image: '/src/assets/Cleaning.jpg' },
    { name: 'Home & Office', icon: '🏠', image: '/src/assets/Home & Office.jpg' },
    { name: 'Personal Care', icon: '🧴', image: '/src/assets/Personal Care.jpg' },
    { name: 'Dry Fruits & Nuts', icon: '🥜', image: '/src/assets/Dry Fruits & Nuts.jpg' },
    { name: 'Edible Oils', icon: '🛢️', image: '/src/assets/Edible Oils.jpg' },
    { name: 'Flours', icon: '🌾', image: '/src/assets/Flours.jpg' },
    { name: 'Rice & Rice Products', icon: '🍚', image: '/src/assets/Rice & Rice Products.jpg' },
    { name: 'Frozen & Instant Food', icon: '🍕', image: '/src/assets/Frozen & Instant Food.jpg' },
    { name: 'Fish, Prawns & Seafood', icon: '🐟', image: '/src/assets/Fish, Prawns & Seafood.jpg' },
    { name: 'Mutton, Duck & Lamb', icon: '🍖', image: '/src/assets/Mutton, Duck & Lamb.jpg' },
    { name: 'Sauces & Seasoning', icon: '🧂', image: '/src/assets/Sauces & Seasoning.jpg' },
    { name: 'Masala, Salt & Sugar', icon: '🧂', image: '/src/assets/Masala, Salt & Sugar.jpg' },
    { name: 'Kitchenware', icon: '🍳', image: '/src/assets/Kitchenware.jpg' },
    { name: 'Packaging Material', icon: '📦', image: '/src/assets/Packaging Material.jpg' },
    { name: 'Canned & Imported Items', icon: '🥫', image: '/src/assets/Canned & Imported Items.jpg' },
    { name: 'Pulses', icon: '🫘', image: '/src/assets/Pulses.jpg' }
  ];
