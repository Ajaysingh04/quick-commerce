...
const CustomersList = () => {
 ...
 User Management
 <span className="bg-emerald-600 text-white text-xs px-2.5 py-0.5 rounded-full">{users.length}</span>
 </h3>
 ...
 selectedKycUser.kyc.status === 'rejected' ? 'bg-rose-100 text-rose-600' : 'bg-emerald-100 text-slate-600'
 }`}>
 ...
 <button onClick={() => setIsKycModalOpen(false)} className="p-2 hover:bg-emerald-100 :bg-slate-800 rounded-full transition-colors">
 ...
 <img src={selectedKycUser.kyc.pan} alt="PAN Card" className="w-full h-48 object-cover rounded-xl border border-emerald-200 " />
 ) : (
 <div className="w-full h-48 bg-emerald-100 rounded-xl flex items-center justify-center text-slate-400 text-sm border border-dashed border-slate-300 ">Not uploaded</div>
 )}
 </div>
 <div>
 <h4 className="text-sm font-bold text-slate-800 mb-3 flex items-center gap-2">
 <FileText className="w-4 h-4 text-emerald-600" /> Aadhar Card
 </h4>
 {selectedKycUser.kyc.aadhar ? (
 <img src={selectedKycUser.kyc.aadhar} alt="Aadhar Card" className="w-full h-48 object-cover rounded-xl border border-emerald-200 " />
 ) : (
 <div className="w-full h-48 bg-emerald-100 rounded-xl flex items-center justify-center text-slate-400 text-sm border border-dashed border-slate-300 ">Not uploaded</div>
 )}
 </div>
 ...
 <div>
 <h4 className="text-sm font-bold text-slate-800 mb-3 flex items-center gap-2">
 <FileText className="w-4 h-4 text-emerald-600" /> Driving License
 </h4>
 {selectedKycUser.kyc.license ? (
 <img src={selectedKycUser.kyc.license} alt="Driving License" className="w-full h-48 object-cover rounded-xl border border-emerald-200 " />
 ) : (
 <div className="w-full h-48 bg-emerald-100 rounded-xl flex items-center justify-center text-slate-400 text-sm border border-dashed border-slate-300 ">Not uploaded</div>
 )}
 </div>
 <div>
 <h4 className="text-sm font-bold text-slate-800 mb-3 flex items-center gap-2">
 <User className="w-4 h-4 text-emerald-600" /> Selfie Video
 </h4>
 {selectedKycUser.kyc.selfieVideo ? (
 <video src={selectedKycUser.kyc.selfieVideo} controls className="w-full h-48 object-cover rounded-xl border border-emerald-200 bg-black" />
 ) : (
 <div className="w-full h-48 bg-emerald-100 rounded-xl flex items-center justify-center text-slate-400 text-sm border border-dashed border-slate-300 ">Not uploaded</div>
 )}
 </div>
