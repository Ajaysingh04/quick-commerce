            ...
            <div className={css.body}>
                ...
                <div className={css.orders}>
                    ...
                    <div className={css.order}>
                        <div className={css.productTypeImgBox}>
                            <img className={css.productTypeImg} src={vegIcon} alt="product type icon" />
                        </div>
                    ...
                    <div className={css.order}>
                        <div className={css.productTypeImgBox}>
                            <img className={css.productTypeImg} src={nonvegIcon} alt="product type icon" />
                        </div>
                        <div className={css.orderTtlBox}>
