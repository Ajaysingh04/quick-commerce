...
import biryaniCImg from '/icons/Product/biryaniC.png';
import burgerImg from '/icons/Product/burger.png';
import chickenImg from '/icons/Product/chicken.png';
import friesImg from '/icons/Product/fries.png';
import homestyleImg from '/icons/Product/homestyle.png';
import noodelsImg from '/icons/Product/noodels.png';
import pannerImg from '/icons/Product/panner.png';
import pizzaImg from '/icons/Product/pizza.png';
import sandwichImg from '/icons/Product/sandwich.png';
import shawarmaImg from '/icons/Product/shawarma.png';
...
import biryaniSCImg from '/images/Product/biryani.png';
import biryaniSCImg2 from '/images/Product/biryani2.png';
import chapathiImg from '/images/Product/chapathi.png';
import chickenSCImg from '/images/Product/chicken.png';
import fishImg from '/images/Product/fish.png';
import icecreamImg from '/images/Product/icecream.png';
import kfcSCImg from '/images/Product/kfc.png';
import pizzaSCImg from '/images/Product/pizza.png';
        ...
        <div className={css.innerDiv6}>
            <div className={css.w7}>
                <div className={css.innerDiv6Title}>
                    {page === orderOnlinePage ? "Delivery Stores in Gachibowli" : page === diningOutPage ? "Dine-Out Stores in Gachibowli" : "Nightlife Stores in Gachibowli"}
                </div>
