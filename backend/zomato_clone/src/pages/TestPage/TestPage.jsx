...
import OverviewAboutCard from '../../utils/Cards/StoreBodyCards/OverviewAboutCard/OverviewAboutCard'
import SmallSearchBarUtil from '../../utils/StoreUtils/SmallSearchBarUtil/SmallSearchBarUtil'
import RateYourExperienceCard from '../../utils/Cards/StoreBodyCards/RateYourExperienceCard/RateYourExperienceCard'
import RedBtnHovWithIcon from '../../utils/Buttons/RedBtnHovWithIcon/RedBtnHovWithIcon'

import DropdownUtil from '../../utils/StoreUtils/DropdownUtil/DropdownUtil'

import RestUserReviewedCard from '../../utils/StoreUtils/RestUserReviewedCard/RestUserReviewedCard'
import OfferTrackUtil from '../../utils/StoreUtils/OfferTrackUtil/OfferTrackUtil'
import LabelUtil from '../../utils/StoreUtils/LabelUtil/LabelUtil'
import MenuCard from '../../utils/Cards/StoreBodyCards/MenuCard/MenuCard'
...
const TestPage = () => {
  ...
  return <div>
    ...
    {/* <div style={{}}>
      <ProductItemProduct mustTry={true} ttl="Hariyali Kebab" votes="12" price="1400" desc="Tandoori Prawns [6 Pieces]+Fish Tikka [6 Pieces]+Pathar ka Gosht [6 Pieces]+Boti Kebab [6 Pieces]+Schezwan Tikka [6 Pieces]+Andhra Kebab [6 Pieces]+Seek Kebab [6 Pieces]" vegNonveg={vegIcon} />
      <ProductItemProduct imgSrc={hariyalikebab} ttl="Hariyali Kebab" votes="12" price="1400" desc="Tandoori Prawns [6 Pieces]+Fish Tikka [6 Pieces]+Pathar ka Gosht [6 Pieces]+Boti Kebab [6 Pieces]+Schezwan Tikka [6 Pieces]+Andhra Kebab [6 Pieces]+Seek Kebab [6 Pieces]" vegNonveg={vegIcon} />
    </div> */}
    <div style={{display: "flex"}}>
      <MenuCard ttl="Product Menu" imgSrc={product1} pages="23" />
      <MenuCard ttl="Product Menu" imgSrc={product1} pages="23" />
    </div>
