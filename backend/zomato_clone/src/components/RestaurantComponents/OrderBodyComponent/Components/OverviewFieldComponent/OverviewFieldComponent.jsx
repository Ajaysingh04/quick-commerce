...
const OverviewFieldComponent = () => {
  ...
  const menuData = [
    {ttl: "Product Menu", imgSrc:product1, pages:"23"},
    {ttl: "Product Menu Card", imgSrc:product1, pages:"30"}
  ]
      ...
      <div className={css.leftBox}>
        ...
        <div className={css.sec}>
            ...
            <div className={css.toolTipBox}>
              ...
              {/* <div className={css.toolTip}>The cost for two is computed as follows: Average of 2 appetizers + 2 mains + 2 beverages + 1 dessert. The actual cost you incur at a store might change depending on your appetite, or with changes in store menu prices.</div> */}
            </div>
        </div>
        ...
        <div className={css.sec}>
            <div className={css.subTtl}>Similar Stores</div>
            <div className={css.secBdy}>
