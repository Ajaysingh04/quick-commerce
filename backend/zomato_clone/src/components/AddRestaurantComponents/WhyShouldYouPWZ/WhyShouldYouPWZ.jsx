...
import storeIcon from '/icons/storeIcon.png'
    ...
    return <div className={css.outerDiv}>
        <div className={css.innerDiv}>
            ...
            <div className={css.cards}>
                ...
                <Card4 imgSrc={calenderIcon} title="2.5 lakhs+" tagLine="store listings" />
                <Card4 imgSrc={storeIcon} title="4 crore+" tagLine="monthly orders" />
            </div>
        </div>
    </div>
}
