...
import css from './AddStoreMobileNavbar.module.css';

let AddStoreMobileNavbar = ({ toogleMenu, setToggleMenu }) => {
    ...
    return <div className={css.navbarH}>
        ...
        <div className={dropdownOptions}>
            <Link to='/my-stores' className={css.options}>
                <div className={css.profileName}>My Stores</div>
...
export default AddStoreMobileNavbar;